...
export default function Biography(){
    ...
    return(
      <div className='inner'>
        ...
        <div className='kalam'>
            <img src='https://datastore02.rediff.com/h1500-w1500/thumb/69586A645B6D2A2E3131/rj11u5snitcv7zyw.D.0.Dr.APJ-Abdul-Kalam-Photo.jpg' height={"340px"} width={"300px"} style={{borderRadius:"50%"}}/>
           ...
           <div className='content'> 
            ...
            <p id='wikipedia'>Read more about A. P. J Abdul Kalam <a href="https://en.wikipedia.org/wiki/A._P._J._Abdul_Kalam">Wikipedia</a></p>
           </div>
        </div>
